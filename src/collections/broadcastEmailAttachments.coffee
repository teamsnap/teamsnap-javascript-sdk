exports.loadBroadcastEmailAttachments = (params, callback) ->
  if @isId params
    ...
    throw new TSArgsError 'teamsnap.loadBroadcastEmailAttachments', 'must
      provide an id or query parameters'
...
exports.uploadBroadcastEmailAttachment = (broadcastEmailId, memberId, file, progressCallback, callback) ->
  ...
  params = braodcastEmailId: braodcastEmailId, file: file, memberId: memberId

  @collections.broadcastEmailAttachment.file('uploadBroadcastEmailAttachment',
