...
require.register("test/divisionMessageData", function(exports, require, module) {
describe('Division Message Data', function() {
  return it('should be able to load division message data for team', function(done) {
    return teamsnap.loadDivisionMessageData({
      teamId: team.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
...
require.register("test/divisionMessages", function(exports, require, module) {
describe('DivisionMessages', function() {
  ...
  it('should be able to load all division messages for team', function(done) {
    return teamsnap.loadDivisionMessages(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  it('should be able to mark division message as read by ID', function(done) {
    var alert;
    alert = teamsnap.createBroadcastAlert();
    alert.teamId = team.id;
    alert.memberId = sender.id;
    ...
    return teamsnap.saveBroadcastAlert(alert, function(err, result) {
      ...
      return teamsnap.loadDivisionMessages(team.id, function(err, result) {
        ...
        return teamsnap.markDivisionMessageAsRead(messages[0].id, function(err, result) {
          console.log(err);
          expect(err).to.be["null"];
  ...
  return it('should be able to mark division message as read by object', function(done) {
    var alert;
    alert = teamsnap.createBroadcastAlert();
    alert.teamId = team.id;
    alert.memberId = sender.id;
    ...
    return teamsnap.saveBroadcastAlert(alert, function(err, result) {
      return teamsnap.loadDivisionMessages(team.id, function(err, result) {
        ...
        expect(messages[0].readAt).to.be["null"];
        return teamsnap.markDivisionMessageAsRead(messages[0], function(err, result) {
          console.log(err);
          expect(err).to.be["null"];
          expect(result.readAt).to.not.be["null"];
          return done();
