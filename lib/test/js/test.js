...
require.register("test/assignments.coffee", function(exports, require, module) {
...
require.register("test/availabilities.coffee", function(exports, require, module) {
...
require.register("test/broadcastAlerts.coffee", function(exports, require, module) {
describe('Broadcast Alerts', function() {
  var alert, recipient, sender;
  alert = null;
  sender = null;
  recipient = null;
  ...
  it('should be able to create a broadcast alert', function(done) {
  ...
  it('should be able to load all broadcast alerts for a team', function(done) {
    var alert2;
    ...
    return teamsnap.saveBroadcastAlert(alert2, function(err, result) {
      expect(err).to.be["null"];
      return teamsnap.loadBroadcastAlerts({
        teamId: team.id
      }, function(err, result) {
        expect(err).to.be["null"];
        result.should.be.an('array');
  ...
  it('should be able to load a single broadcast alert', function(done) {
    return teamsnap.loadBroadcastAlerts({
      id: alert.id
    }, function(err, result) {
      expect(err).to.be["null"];
  ...
  it('should be able to delete a broadcast alert', function(done) {
    return teamsnap.deleteBroadcastAlert(alert, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  return it('should be able to bulk delete broadcast alert', function(done) {
    return teamsnap.bulkDeleteBroadcastAlerts([alert.id], function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/broadcastEmail.coffee", function(exports, require, module) {
describe('Broadcast Emails', function() {
  ...
  it('should not save a broadcast email with no recipients unless is a draft', function(done) {
    email = teamsnap.createBroadcastEmail();
    email.teamId = team.id;
    email.memberId = sender.id;
    email.body = "Hello world";
    ...
    email.recipientIds = [];
    email.isDraft = false;
    return teamsnap.saveBroadcastEmail(email).then(function(result) {
  ...
  it('should not save a broadcast email if recipientIds is not an array', function(done) {
    email = teamsnap.createBroadcastEmail();
    email.teamId = team.id;
    email.memberId = sender.id;
    email.body = "Hello world";
  ...
  it('should save a broadcast email with no recipients if it is a draft', function(done) {
    email = teamsnap.createBroadcastEmail();
    email.teamId = team.id;
    email.memberId = sender.id;
    email.body = "Hello world";
  ...
  it('should be able to delete a broadcast email', function(done) {
    return teamsnap.deleteBroadcastEmail(email, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  return it('should be able to bulk delete broadcast email', function(done) {
    return teamsnap.bulkDeleteBroadcastEmails([email.id], function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/broadcastEmailAttachment.coffee", function(exports, require, module) {
describe('Broadcast Email Attachments', function() {
  var email, recipient, sender;
  email = null;
  sender = null;
  recipient = null;
  ...
  return it('should be able to load broadcast email attachments', function(done) {
    return teamsnap.loadBroadcastEmailAttachments({
      broadcastEmailId: email.id
    }, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
...
require.register("test/chai.js", function(exports, require, module) {
;(function(){
...
require.register("test/contactEmailAddresses.coffee", function(exports, require, module) {
...
require.register("test/contactPhoneNumbers.coffee", function(exports, require, module) {
...
require.register("test/contacts.coffee", function(exports, require, module) {
...
require.register("test/customData.coffee", function(exports, require, module) {
...
require.register("test/customFields.coffee", function(exports, require, module) {
describe('Custom Fields', function() {
  return it('should be able to load all custom fields for team', function(done) {
...
require.register("test/divisionAggregates.coffee", function(exports, require, module) {
describe('Division Aggregates', function() {
  return it('should be able to load all league custom fields for team', function(done) {
    return teamsnap.loadDivisionAggregates(division.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/divisionLocations.coffee", function(exports, require, module) {
...
require.register("test/divisionMembers.coffee", function(exports, require, module) {
...
require.register("test/divisionTeamStandings.coffee", function(exports, require, module) {
...
require.register("test/divisions.coffee", function(exports, require, module) {


});

;require.register("test/divisionsPreferences.coffee", function(exports, require, module) {


});

;require.register("test/eventLineupEntries.coffee", function(exports, require, module) {
describe('EventLineupEntries', function() {
  var event, eventLineup, eventLineupEntry, location, member;
  location = null;
  event = null;
  eventLineup = null;
  member = null;
  ...
  before(function(done) {
    eventLineup = teamsnap.createEventLineup({
      eventId: event.id
    });
    return teamsnap.saveEventLineup(eventLineup, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  after(function(done) {
    return teamsnap.deleteEventLineup(eventLineup, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
  ...
  it('should be able to create and save eventLineupEntry for eventLineup', function(done) {
    ...
    return teamsnap.saveEventLineupEntry(eventLineupEntry, function(err, result) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'eventLineupEntry');
      return done();
    });
  });
  return it('should be able to delete eventLineupEntry', function(done) {
    return teamsnap.deleteEventLineupEntry(eventLineupEntry, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/eventLineups.coffee", function(exports, require, module) {
describe('EventLineups', function() {
  var event, eventLineup, location;
  location = null;
  event = null;
  eventLineup = null;
  before(function(done) {
  ...
  it('should be able to load all eventLineups for event', function(done) {
    return teamsnap.loadEventLineups(event.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
  });
  it('should be able to create eventLineup for event', function(done) {
    eventLineup = teamsnap.createEventLineup({
      eventId: event.id
    });
    return teamsnap.saveEventLineup(eventLineup, function(err, result) {
  ...
  return it('should be able to delete a eventLineup', function(done) {
    return teamsnap.deleteEventLineup(eventLineup, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
...
require.register("test/eventStatistics.coffee", function(exports, require, module) {
...
require.register("test/events.coffee", function(exports, require, module) {
...
require.register("test/forumPosts.coffee", function(exports, require, module) {
...
require.register("test/forumSubscriptions.coffee", function(exports, require, module) {
...
require.register("test/forumTopics.coffee", function(exports, require, module) {
...
require.register("test/init.coffee", function(exports, require, module) {
...
;require.register("test/leagueCustomData.coffee", function(exports, require, module) {
...
require.register("test/leagueCustomFields.coffee", function(exports, require, module) {
...
require.register("test/leagueRegistrantDocuments.coffee", function(exports, require, module) {
...
require.register("test/locations.coffee", function(exports, require, module) {
...
require.register("test/memberAssignments.coffee", function(exports, require, module) {
describe('Member Assignments', function() {
  return describe('teamsnap.loadMemberAssignments', function() {
    return it('should load an array of member assignments by team id', function(done) {
      return teamsnap.loadMemberAssignments(team.id, function(err, result) {
        result.should.be.an('array');
        return done();
      });
    });
...
require.register("test/memberBalances.coffee", function(exports, require, module) {
...
require.register("test/memberEmailAddresses.coffee", function(exports, require, module) {
...
require.register("test/memberLinks.coffee", function(exports, require, module) {
...
require.register("test/memberPayments.coffee", function(exports, require, module) {
var memberPayment;
...
require.register("test/memberPhoneNumbers.coffee", function(exports, require, module) {
...
require.register("test/memberPhotos.coffee", function(exports, require, module) {
describe('Member Photos', function() {
  var member;
  member = null;
  before(function(done) {
    member = teamsnap.createMember();
  ...
  it('should be able to load all members photos for a team', function(done) {
    return teamsnap.loadMemberPhotos(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
  ...
  return it('should be able to load a single member photo', function(done) {
    return teamsnap.loadMemberPhoto(member.id, function(err, result) {
      expect(err).to.be["null"];
...
require.register("test/memberStatistics.coffee", function(exports, require, module) {
...
require.register("test/members.coffee", function(exports, require, module) {
...
require.register("test/membersPreferences.coffee", function(exports, require, module) {
...
require.register("test/messageData.coffee", function(exports, require, module) {
...
require.register("test/messages.coffee", function(exports, require, module) {
describe('Messages', function() {
  ...
  it('should be able to mark message as read by object', function(done) {
    var alert;
    alert = teamsnap.createBroadcastAlert();
    alert.teamId = team.id;
    alert.memberId = sender.id;
  ...
  return it('should be able to delete multiple emails', function(done) {
    var email, emails;
    emails = [];
    email = teamsnap.createBroadcastEmail();
    email.teamId = team.id;
    ...
    return teamsnap.saveBroadcastEmail(email, function(err, result) {
      ...
      return teamsnap.saveBroadcastEmail(email, function(err, result) {
        emails.push(result);
        return teamsnap.bulkDeleteMessages(emails, function(err, result) {
          expect(err).to.be["null"];
          return done();
        });
      });
...
require.register("test/opponentResults.coffee", function(exports, require, module) {
...
require.register("test/opponents.coffee", function(exports, require, module) {
...
require.register("test/paymentNotes.coffee", function(exports, require, module) {
...
require.register("test/plans.coffee", function(exports, require, module) {
...
require.register("test/setup.coffee", function(exports, require, module) {
before(function(done) {
...
require.register("test/sports.coffee", function(exports, require, module) {
...
require.register("test/statisticAggregates.coffee", function(exports, require, module) {
describe('Statistic Aggregates', function() {
  return it('should be able to load all statistic aggregates', function(done) {
    return teamsnap.loadStatisticAggregates(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/statisticData.coffee", function(exports, require, module) {
...
require.register("test/statisticGroups.coffee", function(exports, require, module) {
...
require.register("test/statistics.coffee", function(exports, require, module) {
...
require.register("test/teamFees.coffee", function(exports, require, module) {
...
require.register("test/teamMedia.coffee", function(exports, require, module) {
describe('Team Media', function() {
  var member, teamMediaGroup, teamMedium;
  member = null;
  teamMediaGroup = null;
  teamMedium = null;
  before(function(done) {
  ...
  before(function(done) {
    ...
    return teamsnap.saveTeamMediaGroup(teamMediaGroup, function(err, result) {
      expect(err).to.be["null"];
  ...
  it('should be able to create a team video', function(done) {
    ...
    return teamsnap.saveTeamVideoLink(teamMedium, function(err, result) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'teamMedium');
      return done();
    });
  });
  it('should be able to load all team media for team', function(done) {
    return teamsnap.loadTeamMedia(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      result.should.have.property('length', 1);
  ...
  return it('should be able to delete a team medium', function(done) {
    return teamsnap.deleteTeamMedium(teamMedium, function(err, result) {
      expect(err).to.be["null"];
      return done();
    });
  });
...
require.register("test/teamMediaGroups.coffee", function(exports, require, module) {
describe('Team Media Groups', function() {
  var member;
  member = null;
  before(function(done) {
    member = teamsnap.createMember();
  ...
  it('should be able to create a team media group', function(done) {
    var teamMediaGroup;
    teamMediaGroup = teamsnap.createTeamMediaGroup();
    teamMediaGroup.teamId = team.id;
    teamMediaGroup.memberId = member.id;
  ...
  return it('should be able to load all team media groups for team', function(done) {
    return teamsnap.loadTeamMediaGroups(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/teamMediumComments.coffee", function(exports, require, module) {
describe('Team Medium Comments', function() {
  var member, teamMediaGroup, teamMedium;
  member = null;
  teamMediaGroup = null;
  teamMedium = null;
  ...
  it('should be able to create a team medium comment', function(done) {
    var teamMediumComment;
    ...
    return teamsnap.saveTeamMediumComment(teamMediumComment, function(err, response) {
      expect(err).to.be["null"];
      result.should.have.property('type', 'teamMediumComment');
      return done();
    });
  });
  return it('should be able to load all team medium comments for team', function(done) {
    return teamsnap.loadTeamMediumComments(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/teamNames.coffee", function(exports, require, module) {
describe('Team Names', function() {
  var teamname;
  teamname = null;
  return it('should be able to load all team names', function(done) {
    return teamsnap.loadTeamnames(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
require.register("test/teamPhotos.coffee", function(exports, require, module) {
describe('Team Photos', function() {
  it('should be able to load all team photos for a team', function(done) {
    return teamsnap.loadTeamPhotos(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
  ...
  return it('should be able to load a single team photo', function(done) {
    return teamsnap.loadTeamPhoto(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('object');
...
require.register("test/teamPublicSites.coffee", function(exports, require, module) {
...
require.register("test/teamStatistics.coffee", function(exports, require, module) {
...
require.register("test/teams.coffee", function(exports, require, module) {
...
require.register("test/teamsPreferences.coffee", function(exports, require, module) {
...
require.register("test/teamsResults.coffee", function(exports, require, module) {
...
require.register("test/trackedItemStatuses.coffee", function(exports, require, module) {
...
require.register("test/trackedItems.coffee", function(exports, require, module) {
...
require.register("test/users.coffee", function(exports, require, module) {
