...
require.register("test/divisionStandings", function(exports, require, module) {
describe('Division Standings', function() {
  return it('should be able to load division standings', function(done) {
    return teamsnap.loadDivisionStandings(team.id, function(err, result) {
      expect(err).to.be["null"];
      result.should.be.an('array');
      return done();
    });
...
describe('Statistic Data', function() {
  var event, location, statistic, statisticDatum;
  location = null;
  event = null;
  statistic = null;
  statisticDatum = null;
  ...
  return it('should be able to delete a statistic datum', function(done) {
