...
exports.bulkDeleteMessages = function(params, callback) {
  if (Array.isArray(params)) {
    if ((params[0] != null) && typeof params[0] === 'object' && this.isItem(params[0], 'message')) {
      params = {
        id: params.map(function(item) {
          return item.id;
        })
      };
    } else if (this.isId(params[0])) {
      params = {
        id: params
      };
    } else {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.18.0';
