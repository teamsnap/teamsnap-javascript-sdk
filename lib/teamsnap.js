...
requestBuilder = function(requestId, method, url, data, error) {
  var collection, eventData, eventName, id, lastUrlPart, type, urlParts;
...
requestResponse = function(requestId, method, xhr) {
  var collection, collectionItems, collections, data, eventData, ref, refIds, type, urlParts;
  data = xhr.data;
  eventData = null;
  if (method.toUpperCase() === 'DELETE') {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.25.0';
