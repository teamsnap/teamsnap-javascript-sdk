...
require.register("collections/divisionMessageData", function(exports, require, module) {
exports.loadDivisionMessageData = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  } else if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadDivisionMessageData', 'must provide a teamId or query parameters');
  }
  return this.loadItems('divisionMessageDatum', params, callback);
};

});

require.register("collections/divisionMessages", function(exports, require, module) {
exports.loadDivisionMessages = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  } else if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadDivisionMessages', 'must provide a teamId or query parameters');
  }
  return this.loadItems('divisionMessage', params, callback);
};

exports.markDivisionMessageAsRead = function(params, callback) {
  if (typeof params === 'object') {
    ...
    throw new TSArgsError('teamsnap.markDivisionMessageAsRead', 'a message `id` or `message` object must be provided');
  }
  return this.collections.messages.exec('markDivisionMessageAsRead', params).pop().callback(callback);
};
...
modifySDK = function(sdk) {
  ...
  return wrapMethod(sdk, 'importMembersFromTeam', function(importMembersFromTeam) {
...
add(require('./collections/divisionMessages'));

add(require('./collections/divisionMessageData'));
...
types = ['user', 'assignment', 'availability', 'broadcastAlert', 'broadcastEmail', 'broadcastEmailAttachment', 'contact', 'contactEmailAddress', 'contactPhoneNumber', 'customDatum', 'customField', 'leagueCustomDatum', 'leagueCustomField', 'divisionContact', 'divisionContactEmailAddress', 'divisionContactPhoneNumber', 'divisionLocation', 'divisionMember', 'divisionMemberEmailAddress', 'divisionMemberPhoneNumber', 'divisionMemberPreferences', 'divisionMessage', 'divisionMessageDatum', 'divisionTeamStanding', 'event', 'eventStatistic', 'facebookPage', 'forumPost', 'forumSubscription', 'forumTopic', 'leagueRegistrantDocument', 'location', 'member', 'memberBalance', 'memberEmailAddress', 'memberFile', 'memberLink', 'memberPayment', 'memberPhoneNumber', 'memberPreferences', 'memberStatistic', 'message', 'messageDatum', 'opponent', 'opponentResults', 'paymentNote', 'plan', 'smsGateway', 'sponsor', 'statistic', 'statisticAggregate', 'statisticDatum', 'statisticGroup', 'sport', 'team', 'teamFee', 'teamMedium', 'teamMediumComment', 'teamMediaGroup', 'teamPaypalPreferences', 'teamPreferences', 'teamPublicSite', 'teamResults', 'teamStatistic', 'timeZone', 'trackedItem', 'trackedItemStatus'];
