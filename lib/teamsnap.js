    ...
    auth: function(token, cachedCollections, callback) {
      ...
      if (teamsnap.apiUrl.indexOf(':3000') !== -1) {
        ...
        authedRequest.hook(function(xhr) {
          return xhr.setRequestHeader('X-Teamsnap-User-ID', 1);
        });
...
exports.loadPreferences = function(params, callback) {
  ...
  return promises.when(this.loadMemberPreferences(params), this.loadTeamPreferences(params)).callback(callback);
};
