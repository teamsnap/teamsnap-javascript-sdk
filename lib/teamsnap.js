...
require.register("collections/registrationLineItemOptions.coffee", function(exports, require, module) {
exports.loadRegistrationLineItemOptions = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  ...
  if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadRegistrationLineItemOptions', 'must provide a teamId or', 'must provide query parameters');
  }
  return this.loadItems('registrationLineItemOption', params, callback);
};

});

require.register("collections/registrationLineItems.coffee", function(exports, require, module) {
exports.loadRegistrationLineItems = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  ...
  if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadRegistrationLineItems', 'must provide a teamId or', 'must provide query parameters');
  }
  return this.loadItems('registrationLineItem', params, callback);
};
...
modifySDK = function(sdk) {
    ...
    return function(options, callback) {
      return invite.call(this, options).then(function(result) {
        ...
        if (options.hasOwnProperty('memberId')) {
          ...
          return promises.when(sdk.loadMemberEmailAddresses({
            memberId: memberId
  ...
  return wrapMethod(sdk, 'inviteContactEmailAddresses', function(inviteContactEmailAddresses) {
    return function(params, callback) {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.39.0';
