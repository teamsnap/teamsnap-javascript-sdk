...
types = ['user', 'assignment', 'availability', 'contact', 'contactEmailAddress', 'contactPhoneNumber', 'customDatum', 'customField', 'event', 'location', 'member', 'memberEmailAddress', 'memberFile', 'memberLink', 'memberPhoneNumber', 'memberPreferences', 'opponent', 'plan', 'smsGateway', 'sport', 'team', 'teamPreferences', 'teamPublicSite', 'timeZone', 'trackedItem', 'trackedItemStatus'];
