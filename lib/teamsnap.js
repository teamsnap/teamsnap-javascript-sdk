...
eventSets = ['future_games_and_events', 'future_games', 'future_events'];
...
exports.createBulkAssignments = function(eventSet, description, teamId, createAsMemberId, callback) {
  var params;
  if (!(eventSets.indexOf(eventSet) > -1)) {
    throw new TSArgsError('teamsnap.createBulkAssignments', " `eventSet` must be one of the following: " + eventSets.toString() + ".");
  }
  if (!description.trim()) {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.21.1';
