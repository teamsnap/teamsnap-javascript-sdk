...
exports.uploadMemberPhoto = function(memberId, file) {
  var params;
...
exports.removeMemberPhoto = function(memberId) {
  var params;
  if (this.isItem(memberId, 'member')) {
    memberId = memberId.id;
  }
...
exports.generateMemberThumbnail = function(memberId, x, y, width, height) {
  var params;
  ...
  Item.prototype.toJSON = function() {
    ...
    Object.keys(this).forEach((function(_this) {
      return function(key) {
        ...
        if (Array.isArray(value) || value instanceof Item) {
          return;
        }
...
types = ['user', 'assignment', 'availability', 'contact', 'contactEmailAddress', 'contactPhoneNumber', 'customDatum', 'customField', 'event', 'location', 'member', 'memberEmailAddress', 'memberFile', 'memberLink', 'memberPhoneNumber', 'memberPreferences', 'opponent', 'plan', 'sport', 'team', 'teamPreferences', 'teamPublicSite', 'trackedItem', 'trackedItemStatus'];
...
teamTypes.remove('user').remove('plan').remove('sport');
