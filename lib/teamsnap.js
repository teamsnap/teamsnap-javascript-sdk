...
exports.loadRegistrationLineItemOptions = function(params, callback) {
  if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.registrationLineItemOptions', 'must provide query parameters');
  }
  return this.loadItems('registrationLineItemOptions', params, callback);
};
...
exports.loadRegistrationLineItems = function(params, callback) {
  if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.registrationLineItems', 'must provide query parameters');
  }
  return this.loadItems('registrationLineItems', params, callback);
};
