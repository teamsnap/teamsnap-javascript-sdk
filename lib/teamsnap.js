...
var Collection, Item, MetaList, ScopedCollection, camelize, copy, dateField, dateValue, promises, underscore,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
MetaList = (function() {
  ...
  MetaList.prototype._request = function(request, method, rel, params, type) {
    ...
    return request(method, entry.href, data).then(function(xhr) {
      ...
      items = Item.fromArray(request, (_ref = xhr.data) != null ? (_ref1 = _ref.collection) != null ? _ref1.items : void 0 : void 0) || [];
      if (type === 'item') {
        return items.pop();
      } else {
        return items;
