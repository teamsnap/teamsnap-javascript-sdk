...
require.register("collections/actionLogs.coffee", function(exports, require, module) {
exports.teamImportCompleted = function(teamId, importedRostersCount, callback) {
  var params;
  if (!(((teamId != null) && this.isId(teamId)) && (importedRostersCount != null))) {
    throw new TSArgsError('teamsnap.teamImportCompleted', 'teamId and importedRostersCount must be present');
  }
  params = {
    teamId: teamId,
    importedRostersCount: importedRostersCount
  };
  return this.collections.actionLogs.exec('teamImportCompleted', params, callback);
};
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.60.0';
...
teamTypes.remove('actionLog').remove('user').remove('plan').remove('smsGateway').remove('sport').remove('timeZone');
