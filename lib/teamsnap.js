...
modifySDK = function(sdk) {
  ...
  wrapSave(sdk, 'saveStatistic', function(statistic) {
    ...
    bulkLoadTypes = 'statisticDatum, memberStatistic, teamStatistic, statisticAggregate';
  ...
  wrapSave(sdk, 'bulkSaveStatisticData', function(templates) {
    ...
    if ((templates[0] != null) && (templates[0].memberId != null)) {
      ...
      return sdk.bulkLoad(teamId, "memberStatistic,statisticDatum,statisticAggregate");
    }
  });
  wrapSave(sdk, 'saveStatisticDatum', function(statisticDatum) {
    var teamId;
    teamId = statisticDatum.teamId;
    sdk.bulkLoad(teamId, "statisticDatum,statisticAggregate");
  ...
  wrapMethod(sdk, 'bulkDeleteStatisticData', function(bulkDeleteStatisticData) {
    return function(member, event, callback) {
      ...
      return bulkDeleteStatisticData.call(this, member, event).then(function(result) {
        var bulkLoadTypes, teamId;
        return promises.when(teamId = member.teamId, bulkLoadTypes = "memberStatistic,statisticDatum,statisticAggregate", sdk.bulkLoad(teamId, bulkLoadTypes)).then(function() {
          return result;
        });
      }).fail(function(err) {
        linking.linkItems(toRemove, lookup);
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.7.0-pre19';
...
types = ['user', 'assignment', 'availability', 'broadcastAlert', 'broadcastEmail', 'broadcastEmailAttachment', 'contact', 'contactEmailAddress', 'contactPhoneNumber', 'customDatum', 'customField', 'leagueCustomDatum', 'leagueCustomField', 'divisionContact', 'divisionContactEmailAddress', 'divisionContactPhoneNumber', 'divisionLocation', 'divisionMember', 'divisionMemberEmailAddress', 'divisionMemberPhoneNumber', 'divisionMemberPreferences', 'divisionTeamStanding', 'event', 'facebookPage', 'forumPost', 'forumSubscription', 'forumTopic', 'leagueRegistrantDocument', 'location', 'member', 'memberBalance', 'memberEmailAddress', 'memberFile', 'memberLink', 'memberPayment', 'memberPhoneNumber', 'memberPreferences', 'memberStatistic', 'opponent', 'opponentResults', 'paymentNote', 'plan', 'smsGateway', 'sponsor', 'statistic', 'statisticAggregate', 'statisticDatum', 'statisticGroup', 'sport', 'team', 'teamFee', 'teamMedium', 'teamMediumComment', 'teamMediaGroup', 'teamPaypalPreferences', 'teamPreferences', 'teamPublicSite', 'teamResults', 'teamStatistic', 'timeZone', 'trackedItem', 'trackedItemStatus'];
