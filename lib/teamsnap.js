...
exports.uploadBroadcastEmailAttachment = function(broadcastEmailId, memberId, file, progressCallback, callback) {
  ...
  params = {
    braodcastEmailId: braodcastEmailId,
    file: file,
    memberId: memberId
  };
  return this.collections.broadcastEmailAttachment.file('uploadBroadcastEmailAttachment', params, progressCallback, callback);
};
