...
require.register("collections/forecasts", function(exports, require, module) {
exports.loadForecast = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  ...
  return this.collections.root.queryItems('forecast', params, callback);
};
