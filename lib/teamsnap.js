...
exports.ancestorDivisions = function(divisionId, callback) {
  ...
  return this.collections.divisions.exec('ancestors', {
    id: divisionId
  }, callback);
};
...
exports.descendantDivisions = function(divisionId, callback) {
  ...
  return this.collections.divisions.exec('descendants', {
    id: divisionId
  }, callback);
};

exports.divisionChildren = function(divisionId, callback) {
  if (!this.isId(divisionId)) {
    throw new TSArgsError('teamsnap.loadDivision', 'divisionId must be provided');
  }
  return this.collections.divisions.exec('children', {
    id: divisionId
  }, callback);
};
...
modifySDK = function(sdk) {
  ...
  return wrapMethod(sdk, 'markMessageAsRead', function(markMessageAsRead) {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.16.1';
