...
unlinkItems = function(items, lookup) {
  ...
  if (Array.isArray(items)) {
    ...
    return unlinkItem(items, lookup);
  }
};
...
var Collection, Item, MetaList, ScopedCollection, camelize, copy, promises, underscore,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
sendRequest = function(method, url, data, hooks, callback) {
  ...
  xhr.onreadystatechange = function() {
    var e, errorMsg, _ref, _ref1, _ref2;
    switch (xhr.readyState) {
      ...
      case 4:
        ...
        if (xhr.status >= 400) {
          errorMsg = ((_ref = xhr.response) != null ? (_ref1 = _ref.collection) != null ? (_ref2 = _ref1.error) != null ? _ref2.message : void 0 : void 0 : void 0) || '';
        }
        if (xhr.status === 0) {
          if (unloading) {
