...
require.register("collections/usersDSPPayload.coffee", function(exports, require, module) {
exports.loadDSPPayload = function(params, callback) {
  if (this.isId(params)) {
    params = {
      memberId: params
    };
  ...
  return this.loadItems('users/dsp_payload', params, callback);
};
