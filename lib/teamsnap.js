...
exports.createInvoiceTransactions = function(data) {
  return this.createItem(data, {
...
exports.deleteInvoiceTransaction = function(invoiceTransaction, callback) {
  if (!invoiceTransaction) {
    throw new TSArgsError('teamsnap.deleteInvoiceTransaction', '`invoiceTransaction` must be provided');
  }
  return this.deleteItem(invoiceTransaction, callback);
};
...
modifySDK = function(sdk) {
  ...
  return wrapMethod(sdk, 'disableMember', function(disableMember) {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.36.0';
