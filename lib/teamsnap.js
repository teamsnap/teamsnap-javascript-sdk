...
exports.saveInvoiceLineItem = function(invoiceLineItem, callback) {
  ...
  if (!invoiceLineItem.batchInvoiceId) {
  ...
  if (!invoiceLineItem.amount) {
    return this.reject('You must provide a amount.', 'amount', callback);
  }
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.33.0';
