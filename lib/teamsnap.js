...
exports.sendAssignmentEmails = function(teamId, eventIds, message, callback) {
  var params;
  if (!this.isId(teamId)) {
    thrown(new TSArgsError('teamsnap.sendAssignmentEmails', "must provide a `teamId`"));
  }
  if (!eventIds) {
...
modifySDK = function(sdk) {
  ...
  return wrapMethod(sdk, 'deleteMemberAssignment', function(deleteMemberAssignment) {
    return function(memberAssignment, callback) {
      return deleteMemberAssignment.call(this, memberAssignment).then(function(result) {
        return sdk.loadAssignments({
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.15.0';
