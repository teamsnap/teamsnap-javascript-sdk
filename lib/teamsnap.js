...
exports.sendEmailValidation = function(callback) {
  return this.collections.users.exec('sendEmailValidation').pop().callback(callback);
};
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.48.0';
