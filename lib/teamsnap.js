...
_ref = exports.AVAILABILITY_STATUSES;
for (key in _ref) {
  value = _ref[key];
  statuses[value] = true;
...
exports.loadAvailabilities = function(params, callback) {
  ...
  return this.loadItems('availabilities', params, callback);
};

exports.createAvailability = function(data) {
...
exports.deleteAvailability = function(availability) {
  if (!availability) {
    throw new TSArgsError('teamsnap.deleteAvailability', '`availability` must be provided');
  }
  return this.deleteItem(availability);
};
});
...
exports.loadContacts = function(params, callback) {
  ...
  return this.loadItems('contacts', params, callback);
};
...
exports.deleteContact = function(contact) {
  ...
  return this.deleteItem(contact);
};
...
exports.EVENT_INCLUDE = [exports.INCLUDE_NONE, exports.INCLUDE_FUTURE, exports.INCLUDE_ALL];

includes = {};

_ref = exports.EVENT_INCLUDE;
...
exports.deleteEvent = function(event, include) {
  var params;
  if (!event) {
  ...
  if (include) {
    if (!includes[include]) {
      throw new TSArgsError('teamsnap.deleteEvent', "`include` must be one " + (exports.EVENT_INCLUDE.join(', ')));
    }
    params = {
      repeatingInclude: include
    };
  }
  return this.deleteItem(event, params);
};
...
exports.deleteMemberPhoto = function(memberId) {
  ...
  return teamsnap.load().then(function() {
    var params;
    params = {
      memberId: memberId
    };
    return teamsnap.collections.members.exec('removeOriginalPhoto', params).pop().callback(callback);
  });
};

exports.deleteThumbnail = function(memberId) {
  if (!memberId) {
  ...
  return teamsnap.load().then(function() {
    ...
    return teamsnap.collections.members.exec('removeThumbnailPhoto', params).pop().callback(callback);
  });
};

exports.generateThumbnail = function(member, x, y, width, height) {
  return teamsnap.loadCollection('members').then(function(collection) {
    var params;
    params = {
      memberId: member.id,
      cropX: x,
    ...
    return collection.exec('generateThumbnailPhoto', params).then(teamsnap.toItem).then(teamsnap.add);
  });
};
...
teamsnap.loadPlan = function(teamId) {
  var params;
  if (!this.isId(teamId)) {
...
;require.register("collections/preferences", function(exports, require, module) {
var promises;
...
exports.loadPreferences = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  } else if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadPreferences', 'must provide a teamId or query parameters');
  }
  return promises.when(exports.loadMemberPreferences(params), exports.loadTeamPreferences(params)).callback(callback);
};
...
exports.savePreferences = function(memberPreferences, teamPreferences, callback) {
  if (!(memberPreferences && teamPreferences)) {
    throw new TSArgsError('teamsnap.saveTeamPreferences', "`memberPreferences` and `teamPreferences` must be provided");
  }
  if (!this.isItem(memberPreferences, 'memberPreferences')) {
    throw new TSArgsError('teamsnap.saveTeamPreferences', "`memberPreferences.type` must be 'memberPreferences'");
  }
  if (!this.isItem(teamPreferences, 'teamPreferences')) {
    throw new TSArgsError('teamsnap.saveTeamPreferences', "`teamPreferences.type` must be 'teamPreferences'");
  }
  return promises.when(this.saveItem(memberPreferences), this.saveItem(teamPreferences)).callback(callback);
};
});

;require.register("collections/refreshments", function(exports, require, module) {
exports.loadRefreshments = function(params, callback) {
  if (this.isId(params)) {
    params = {
      teamId: params
    };
  } else if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadRefreshments', 'must provide a teamId or query parameters');
  }
  return this.loadItems('refreshment', params, callback);
};

exports.createRefreshment = function(data) {
  return this.createItem(data, {
    type: 'refreshment',
    description: ''
  });
...
exports.saveRefreshment = function(refreshment, callback) {
  var _ref;
  if (!refreshment) {
    throw new TSArgsError('teamsnap.saveRefreshment', "`refreshment` must be provided");
  }
  if (!this.isItem(refreshment, 'refreshment')) {
    throw new TSArgsError('teamsnap.saveRefreshment', "`refreshment.type` must be 'refreshment'");
  }
  if (!refreshment.memberId) {
    return this.reject('You must choose a member.', 'memberId', callback);
  }
  if (!refreshment.eventId) {
    return this.reject('You must choose an event.', 'eventId', callback);
  }
  if (!((_ref = refreshment.description) != null ? _ref.trim() : void 0)) {
    return this.reject('You must provide a description for the refreshment.', 'name', callback);
  }
  return this.saveItem(refreshment, callback);
};

exports.deleteRefreshment = function(refreshment, callback) {
  if (!refreshment) {
    throw new TSArgsError('teamsnap.deleteRefreshment', '`refreshment` must be provided');
  }
  return this.deleteItem(refreshment, callback);
};

exports.refreshmentSort = function(reverse) {
  return (function(_this) {
    return function(itemA, itemB) {
      var valueA, valueB;
      if (!_this.isItem(itemA, 'refreshment') || !_this.isItem(itemB, 'refreshment')) {
        valueA = itemA.type;
        valueB = itemB.type;
      } else {
...
teamsnap.loadSport = function(teamId) {
  var params;
  if (!this.isId(teamId)) {
...
exports.loadTeamItems = function(teamId, types, callback) {
  var params;
  if (!this.isId(teamId)) {
...
exports.deleteTeam = function(team) {
  ...
  return this.deleteItem(team);
};
});

;require.register("collections/tracking", function(exports, require, module) {
var key, statuses, value, _ref;
...
_ref = exports.TRACKING_STATUSES;
for (key in _ref) {
  value = _ref[key];
  statuses[value] = true;
...
exports.saveTrackedItem = function(trackedItem, callback) {
  ...
  if (!((_ref1 = trackedItem.name) != null ? _ref1.trim() : void 0)) {
...
exports.createTrackedItemStatus = function(data) {
  return this.createItem(data, {
...
exports.deleteTrackedItemStatus = function(trackedItemStatus, callback) {
  if (!trackedItemStatus) {
    throw new TSArgsError('teamsnap.deleteTrackedItemStatus', '`trackedItemStatus` must be provided');
  }
  return this.deleteItem(trackedItemStatus, callback);
};

exports.trackedItemSort = function() {
  return (function(_this) {
    return function(itemA, itemB) {
      var valueA, valueB;
...
Collection = (function() {
  ...
  function Collection(data) {
    ...
    this.queries = new MetaList(data != null ? data.queries : void 0);
    this.commands = new MetaList(data != null ? data.commands : void 0);
    this.template = (data != null ? data.template : void 0) || [];
  }
...
ScopedCollection = (function(_super) {
  ...
  function ScopedCollection(request, collection) {
    ...
    if (collection.items) {
      this.items = Item.fromArray(this.request, collection.items);
    }
  }
  ...
  ScopedCollection.prototype.save = function(item, callback) {
    ...
    this.request(method, item.href || this.href, data).then(function(xhr) {
  ...
  ScopedCollection.prototype.loadCollection = function(linkName, callback) {
    return this.links.loadCollection(this.request, linkName, callback);
  };

  ScopedCollection.prototype.loadItems = function(linkName, callback) {
    return this.links.loadItems(this.request, linkName, callback);
  };

  ScopedCollection.prototype.loadItem = function(linkName, callback) {
    return this.links.loadItem(this.request, linkName, callback);
  };

  ScopedCollection.prototype.queryItems = function(queryName, params, callback) {
    return this.queries.loadItems(this.request, queryName, params, callback);
  };

  ScopedCollection.prototype.queryItem = function(queryName, params, callback) {
    return this.queries.loadItem(this.request, queryName, params, callback);
  };

  ScopedCollection.prototype.exec = function(commandName, params, callback) {
    return this.commands.exec(this.request, commandName, params, callback);
  };

  ScopedCollection.prototype.toJSON = function() {
    var obj;
    obj = copy(this, {});
    delete obj.request;
    return obj;
...
Item = (function() {
  ...
  Item.fromData = function(request, data) {
    return new Item(request).deserialize(data);
  };

  function Item(request, data) {
    this.request = request;
    this.links = new MetaList();
    if (data) {
      copy(data, this);
    }
  }
  ...
  Item.prototype.loadCollection = function(linkName, callback) {
    return this.links.loadCollection(this.request, linkName, callback);
  };
  ...
  Item.prototype["delete"] = function(params, callback) {
    ...
    return this.request["delete"](this.href, data).callback(callback);
  };
...
MetaList = (function() {
  ...
  MetaList.prototype.deserialize = function(data) {
    var entry, key, param, params, value, _i, _j, _len, _len1, _ref, _results;
    for (key in this) {
      value = this[key];
      delete this[key];
    }
  ...
  MetaList.prototype.loadCollection = function(request, rel, params, callback) {
    if (typeof params === 'function') {
      callback = params;
      params = void 0;
    }
    return this._request(request, 'get', rel, params, 'collection').callback(callback);
  };
  ...
  MetaList.prototype._request = function(request, method, rel, params, type) {
    ...
    return request(method, entry.href, data).then(function(xhr) {
      var items, _ref;
      if (type === 'collection') {
        return ScopedCollection.fromData(request, xhr.response);
      } else {
...
createSDKObject = function(request, collections) {
  ...
  sdk = {
    ...
    createItem: function(properties, defaults) {
      ...
      return new Item(this.request, properties);
    },
    ...
    deleteItem: function(item, params, callback) {
      ...
      if (!(item instanceof Item)) {
        item = new Item(this.request, item);
      }
    ...
    getCollectionForItem: function(item) {
      ...
      collectionName = this.getPluralRel(type);
...
var plural, pluralLookup, singular, singularLookup, teamTypes, teamsnap, type, typeLookup, types, _i, _len;

teamsnap = exports;

types = ['user', 'availability', 'contact', 'event', 'location', 'member', 'memberEmailAddress', 'memberPhoneNumber', 'memberPreferences', 'opponent', 'plan', 'refreshment', 'sport', 'team', 'teamPreferences', 'teamPublicSite', 'trackedItem', 'trackedItemStatus'];
...
teamsnap.getRelType = function(name) {
