...
require.register("collections/messagesReplies.coffee", function(exports, require, module) {
exports.loadMessagesReplies = function(params, callback) {
  if (this.isId(params)) {
    params = {
      messageId: params
    };
  } else if (!(params && typeof params === 'object')) {
    throw new TSArgsError('teamsnap.loadMessagesReplies', 'must provide a messageId or query parameters');
  }
  return this.loadItems('messageReplies', params, callback);
};
...
add(require('./collections/messagesReplies'));
