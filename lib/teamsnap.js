...
require.register("collections/divisionEvents", function(exports, require, module) {
...
require.register("collections/divisionMembersPreferences", function(exports, require, module) {
exports.PREFS = {
  SCHEDULE_SHOW: {
    ALL: 1,
    GAMES: 2,
...
require.register("collections/divisionsPreferences", function(exports, require, module) {
...
require.register("collections/memberAssignments", function(exports, require, module) {
...
exports.bulkDeleteMembers = function(members, callback) {
  if (Array.isArray(members)) {
    ...
    } else if (this.isItem(members[0], 'member')) {
      members = {
        memberId: members.map(function(member) {
          return member.id;
        })
      };
    } else if (this.isId(members[0])) {
      members = {
        memberId: members
      };
    } else {
  ...
  } else if (this.isId(members)) {
    members = {
      memberId: members
    };
  } else {
    throw new TSArgsError('teamsnap.bulkDeleteMembers', 'Must provide an `array` of member `ids`, an `id` or a `member` object');
  }
  return this.collections.members.exec('bulkDelete', members).callback(callback);
};

exports.moveMember = function(params, callback) {
  if (!params.memberId) {
    throw new TSArgsError('teamsnap.moveMember', 'params must include `memberId`');
  }
  if (!params.divisionId) {
    throw new TSArgsError('teamsnap.moveMember', 'params must include `divisionId`');
  }
  if (Array.isArray(params.memberId)) {
    if (params.memberId.length === 0) {
      throw new TSArgsError('teamsnap.moveMember', 'The array of memberId in params is empty.');
    } else if (this.isItem(params.memberId[0], 'member')) {
      params.memberId = params.memberId.map(function(member) {
        return member.id;
      });
    }
  } else if (this.isItem(params.memberId, 'member')) {
    params.memberId = params.memberId.id;
  } else if (this.isId(params.memberId)) {
    params.memberId = params.memberId;
  } else {
    throw new TSArgsError('teamsnap.moveMember', 'Must provide an `array` of member `ids` or `member` objects for memberId');
  }
...
require.register("collections/opponentsResults", function(exports, require, module) {
...
require.register("collections/registrationForms", function(exports, require, module) {
...
require.register("collections/teamsPaypalPreferences", function(exports, require, module) {
...
require.register("collections/teamsPreferences", function(exports, require, module) {
...
require.register("collections/teamsResults", function(exports, require, module) {
...
modifySDK = function(sdk) {
  ...
  return wrapMethod(sdk, 'createBulkAssignments', function(createBulkAssignments) {
...
TeamSnap = (function() {
  TeamSnap.prototype.version = '1.21.3';
...
<<<<<<< 90043d88e90f43b805f1d6b6b6ac542c8911bfa3
...
=======
types = ['user', 'assignment', 'availability', 'broadcastAlert', 'broadcastEmail', 'broadcastEmailAttachment', 'contact', 'contactEmailAddress', 'contactPhoneNumber', 'customDatum', 'customField', 'leagueCustomDatum', 'leagueCustomField', 'divisionContact', 'divisionContactEmailAddress', 'divisionContactPhoneNumber', 'divisionLocation', 'divisionMember', 'divisionMemberEmailAddress', 'divisionMemberPhoneNumber', 'divisionMemberPreferences', 'divisionTeamStanding', 'divisionPreferences', 'division', 'event', 'eventStatistic', 'facebookPage', 'forumPost', 'forumSubscription', 'forumTopic', 'leagueRegistrantDocument', 'location', 'member', 'memberAssignment', 'memberBalance', 'memberEmailAddress', 'memberFile', 'memberLink', 'memberPayment', 'memberPhoneNumber', 'memberPhoto', 'memberPreferences', 'memberStatistic', 'message', 'messageDatum', 'opponent', 'opponentResults', 'paymentNote', 'plan', 'registrationForm', 'smsGateway', 'sponsor', 'statistic', 'statisticAggregate', 'statisticDatum', 'statisticGroup', 'sport', 'team', 'teamFee', 'teamMedium', 'teamMediumComment', 'teamMediaGroup', 'teamPaypalPreferences', 'teamPhoto', 'teamPreferences', 'teamPublicSite', 'teamResults', 'teamStatistic', 'timeZone', 'trackedItem', 'trackedItemStatus'];
>>>>>>> Add registrationForm collection
