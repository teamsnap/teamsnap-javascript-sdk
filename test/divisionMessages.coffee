describe 'DivisionMessages', ->
  ...
  it 'should be able to load all division messages for team', (done) ->
    teamsnap.loadDivisionMessages team.id, (err, result) ->
      expect(err).to.be.null
      result.should.be.an('array')
      done()


  it 'should be able to mark division message as read by ID', (done) ->
  ...
  it 'should be able to mark division message as read by object', (done) ->
    alert = teamsnap.createBroadcastAlert()
    alert.teamId = team.id
    alert.memberId = sender.id
    alert.body = "Hello again world"
